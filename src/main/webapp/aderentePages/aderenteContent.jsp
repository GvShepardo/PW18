...
<div class="body">
    ...
    <div class="container" style="text-align: center">
        <div class="content" style="display: inline-block">
            <div class="attivitaProfilo" >
                ...
                <button  class="attivitaPulsante" id="attivita1" onclick="changeStatusAttivita('attivita1')" >ISCRIVITI</button>
            </div>

            <div class="attivitaProfilo">
                <h2 style="font-size: 10px">GIUSTIZIA SOCIALE</h2>
                <img src="../socialJustice.png" alt="Immagine 2">
                <button id="attivita2" onclick="changeStatusAttivita('attivita2')">ISCRIVITI</button>
            </div>

            <div class="attivitaProfilo">
                <h2 style="font-size: 10px">EDUCAZIONE E OSPEDALIZZAZIONE GRATUITA </h2>
                <img src="../freeEducation.png" alt="Immagine 3">
                <button id="attivita3" onclick="changeStatusAttivita('attivita3')">ISCRIVITI</button>
            </div>
        </div>
    </div>
    ...
    <button onclick="deleteUser()"> CANCELLA PROFILO </button>
</div>
</body>
</html>
