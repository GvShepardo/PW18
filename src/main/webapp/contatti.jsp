...
<%@include file="cookie.jsp"%>
	<div class="container">	<!-- avrei potuto riutilizzare il container dell'header ma per rendere le pagine più indipendenti lo ho rimesso qui -->
		<div class="content">
			...
			<form class="contact-form" method="post" action="donazioni">	<!-- dato che nel testo non era specificato (a differenza della pagina sign-in) ho messo come required solo la e-mail -->
