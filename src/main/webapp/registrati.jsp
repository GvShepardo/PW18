    ...
    <div class="container">
		<div class="content">
			...
			<form method="post">
				...
				<input type="tel" class="phone" name="phone" pattern="^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$" required>
				...
				<label for="password">Password (min. 8 caratteri, una lettera maiuscola, un carattere numerico e un carattere tra $, ! e ?)</label>
				<input type="password" class="password" id="passwordreg" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[$!?\^%&]).{8,}" required>
				<i id="togglePasswordReg" class="fa fa-eye"></i>
				<label for="confirm-password">Conferma password</label>
				<input type="password" class="confirm-password" id="confirm-passwordreg" name="confirm-password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[$!?\^%&]).{8,}" required>
